...
{
   // Material do objeto. Parametros em RGBA
   GLfloat objeto_ambient[]   = { .0215, .1745, .0215, 1.0 };
   GLfloat objeto_difusa[]    = { .07568, .61424, .07568, 1.0 };
   GLfloat objeto_especular[] = { .633, .727811, .633, 1.0 };
